...
__attribute__((always_inline)) void vx_wstm_f32(void* dst, mf32x8_t src, size_t ldm) {
    uint32_t tid = vx_thread_id(); \
    uint32_t i = tid / 4; \
    uint32_t j = tid % 4; \
...
__attribute__((always_inline)) mf32x8_t vx_hmma_844_c_f16_f32(mf32x8_t a, mf32x8_t b, mf32x8_t c) {
    MAKE_VX_HMMA_844_C_F32(0);
}

__attribute__((always_inline)) mf32x8_t vx_hmma_844_d_f16_f32(mf32x8_t a, mf32x8_t b, mf32x8_t c) {
